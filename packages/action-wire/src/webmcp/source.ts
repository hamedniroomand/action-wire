import { AgentError, createEmitter, createToolRegistry } from '~/core';
import type { ToolCall, ToolResult, ToolSnapshot, ToolSource } from '~/core';
import { executeNativeTool } from '~/webmcp/execute';
import { createGeneration, listenForToolChange } from '~/webmcp/lifecycle';
import { getCurrentWindow, getNativeContext } from '~/webmcp/native';
import { normalizeNativeTool } from '~/webmcp/normalize';
