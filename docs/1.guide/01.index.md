...
title: Teams with an application that already works
...
title: Developers who want a chat interface, not an agent platform
...
title: Developers who already write WebMCP tools
icon: i-lucide-plug
---
...
title: Teams that must write down the safety story
icon: i-lucide-shield
to: /guide/confirmations
---
...
:read-more{to="/guide/installation" title="Installation"}
